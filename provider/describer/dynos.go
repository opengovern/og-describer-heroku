...
func GetDyno(ctx context.Context, handler *resilientbridge.ResilientBridge, appName, resourceID string) (*models.Resource, error) {
	...
	value := models.Resource{
		ID:   dyno.ID,
		Name: dyno.Name,
		Description: model.DynoDescription{
			AppID:     dyno.AppID,
...
func processDyno(ctx context.Context, handler *resilientbridge.ResilientBridge, appName, resourceID string) (*model.DynoJSON, error) {
	var dyno model.DynoJSON
	baseURL := "/apps/"
